    ...
    public function match($rawPathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($rawPathinfo.'/', 'pi_user_homepage');
            }

            return array (  '_controller' => 'PI\\UserBundle\\Controller\\DefaultController::indexAction',  '_route' => 'pi_user_homepage',);
        }
